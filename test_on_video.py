...
import skvideo
skvideo.setFFmpegPath('D:\\work\\ffmpeg-2023-03-27-git-f7abe92bd7-full_build\\ffmpeg-2023-03-27-git-f7abe92bd7-full_build\\bin')
import skvideo.io
import ffmpeg
...
if __name__ == "__main__":
    ...
    writer = skvideo.io.FFmpegWriter(f"static/stylized-{video_name}.gif")
